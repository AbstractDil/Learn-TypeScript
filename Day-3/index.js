...
* Number Type
*/
let apples = 5; // isValid = true
let speed = 10.5; // isValid = true
let hasName = true; // isValid = true
let nothingMuch = null; // isValid = true
let nothing = undefined; // isValid = true
...
* String Type
*/
let myName = "Sagar"; // isValid = true
let sentence = `My name is ${myName}`; // isValid = true
...
let message = "Hello TypeScript"; // isValid = true
// Concatenation
